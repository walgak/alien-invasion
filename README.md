...
The latest visual pass adds opaque event horizons, cause-specific hull destruction, flowing gravity-curved lasers with boss absorption, a visible guard-powered boss shield, rotating resistance thrust, finite exit pulses, and varied distant planets with correctly layered rings. See [the code guide](docs/CODE_GUIDE.md) for the render-safety fix and device regression harness.
